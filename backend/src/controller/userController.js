...
//     if (checkPassword) {
//       res.status(200).json({success: true, message: "User logged in successfully", "token": sendToken(isExist, res)});
...
//   //here you can make it different message for differnet errors
//   if ( !name || !email || !password ) {
//     res.status(401).json({ success: false, message: "Enter every  required field" });
//   }

//   //have to integrate it st the user doesn't get registered if the passwords are not mathcing
